package one.jnuit.jni;

import one.jnuit.misc.UnsafeImpl;
...
/*
	public static void main(String[] args) {
		...
		System.out.println();
		//byte[] data = new UnsafeClassLoader().getByteCode("one.jmaster.misc.insecure.NotObject");
		//env.defineClass("one.jmaster.misc.insecure.NotObject",null,data, data.length);

		new UnsafeClassLoader().loadClass("one.jnuit.misc.NotObject");
	}*/
